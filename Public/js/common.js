...
PPD.TreeSelector = function(item,data,rootId,defaultValue){ 
    this._data = data; 
    this._item = item; 
    this._rootId = rootId; 
    if(defaultValue)this.defaultValue = defaultValue;
} 
PPD.TreeSelector.prototype.createTree = function(){ 
...
PPD.TreeSelector.prototype.createSubOption = function(len,current,next){ 
    var blank = ".."; 
    ...
    PPD.TreeSelector.prototype.getLevel = function(datasources,topId,currentitem){ 
...
PPD.getPPDVersion = function(url){
 ...
 * 取文档内容实际高度  
 *******************/  
 PPD.getScrollHeight = function()  
 {  
     return Math.max(document.body.scrollHeight,document.documentElement.scrollHeight);  
 }

 //只能輸入數字
 PPD.isNumberKey = function(evt){
 ...
 //只能輸入數字和小數點
 PPD.isNumberdoteKey = function(evt){
 ...
 //只能輸入數字和字母
 PPD.isNumberCharKey = function(evt){
 	var e = evt || window.event; 
 	var srcElement = e.srcElement || e.target;	
 	var charCode = (evt.which) ? evt.which : event.keyCode;
...
PPD.isChinese = function(obj,isReplace){
 	var pattern = /[\u4E00-\u9FA5]|[\uFE30-\uFFA0]/i
...
//比较时间差
PPD.getTimeDiff = function(startTime,endTime,diffType){
 ...
 * @returns
 */
PPD.checkMinLength = function(o,minLength){
	if(PPD.getBytes(o)<=minLength){
		return false;
	}
	return true;
}
 ...
 * @returns
 */
PPD.checkMaxLength = function(o,maxLength){
	if(PPD.getBytes(o)>maxLength){
		return false;
	}
	return true;
}
PPD.msg = function(msg, options, func){
	var opts = {};
	//有抖動的效果,第二位是函數
...
PPD.toJson = function(str,notLimit){
	var json = {};
	try{
...
$(function () {
	if($('.wst-panel-full').height()<PPD.pageHeight())$('.wst-panel-full').height(PPD.pageHeight()-3);
});
 ...
 * 替换url
 */
PPD.replaceURL = function(url,ar){
...
PPD.checkChks = function(obj,cobj){
	$(cobj).each(function(){
		$(this)[0].checked = obj.checked;
	})
}
PPD.getChks = function(obj){
	var ids = [];
	$(obj).each(function(){
