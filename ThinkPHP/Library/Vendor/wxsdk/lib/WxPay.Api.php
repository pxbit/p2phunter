...
class WxPayApi
{
	...
	{
		$url = "https://api.mch.weixin.qq.com/". SAND_BOX_NEW . "pay/unifiedorder";
		//检测必填参数
		...
		$inputObj->SetSpbill_create_ip("114.92.74.149");
	...
	{
		$url = "https://api.mch.weixin.qq.com/". SAND_BOX_NEW . "pay/orderquery";
		//检测必填参数
	...
	{
		$url = "https://api.mch.weixin.qq.com/". SAND_BOX_NEW . "pay/closeorder";
		//检测必填参数
		if(!$inputObj->IsOut_trade_noSet()) {
	...
	{
		$url = "https://api.mch.weixin.qq.com/". SAND_BOX_NEW . "secapi/pay/refund";
		//检测必填参数
		if(!$inputObj->IsOut_trade_noSet() && !$inputObj->IsTransaction_idSet()) {
	...
	{
		$url = "https://api.mch.weixin.qq.com/". SAND_BOX_NEW . "pay/refundquery";
		//检测必填参数
	...
	{
		$url = "https://api.mch.weixin.qq.com/". SAND_BOX_NEW . "pay/downloadbill";
		//检测必填参数
	...
	{
		$url = "https://api.mch.weixin.qq.com/". SAND_BOX_NEW . "pay/micropay";
		//检测必填参数
	...
	{
		$url = "https://api.mch.weixin.qq.com/". SAND_BOX_NEW . "secapi/pay/reverse";
		//检测必填参数
		if(!$inputObj->IsOut_trade_noSet() && !$inputObj->IsTransaction_idSet()) {
	...
	{
		$url = "https://api.mch.weixin.qq.com/". SAND_BOX_NEW . "payitil/report";
		//检测必填参数
	...
	{
		$url = "https://api.mch.weixin.qq.com/". SAND_BOX_NEW . "tools/shorturl";
		//检测必填参数
