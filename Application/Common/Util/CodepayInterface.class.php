...
class CodepayInterface {
	...
	//获取API接口的域名
	static function getApiHost()
	{
		$mainApi = 1;
		$codePay_api_url = "";
		$codePay_api_url .= CodepayInterface::is_HTTPS() ? "https://" : 'http://';
		$codePay_api_url .= $mainApi ? "codepay.fateqq.com:" : 'api.fateqq.com:'; //应急预案
		$codePay_api_url .= CodepayInterface::is_HTTPS() ? "51888" : '52888';
		$codePay_api_url .= '/';
